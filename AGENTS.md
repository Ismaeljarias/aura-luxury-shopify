...
**IMPORTANT:** This is a custom Shopify theme built using **Dawn** (Shopify's reference theme) as the base template.

### Base Theme Information
- **Base:** Shopify Dawn Theme (v15.0+)
- **Repository:** https://github.com/Shopify/dawn
- **Purpose:** Dawn provides a solid foundation of best practices, performance optimizations, and modern Liquid architecture

### Customizations
This custom theme extends Dawn with:
- Additional luxury styling (`aura-luxury.css`, `aura-product-cards.css`)
- Custom product card designs
- Brand-specific theme settings and color schemes
- Extended features tailored to business needs

### Development Guidelines
- **Core Structure:** Maintains Dawn's directory structure and file organization
- **Base Components:** Utilizes Dawn's sections, snippets, and templates as a foundation
- **Performance:** Inherits Dawn's performance optimizations and best practices
- **Compatibility:** Maintains compatibility with Shopify's latest features and updates
- **DO NOT:** Modify or remove core Dawn structure unless absolutely necessary
- **DO:** Extend functionality through custom sections, snippets, and styling
